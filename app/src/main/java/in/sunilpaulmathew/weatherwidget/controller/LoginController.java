...
public class LoginController {
 ...
 //                               Toast.makeText(mContext, "Login Failed: " + signInTask.getException().getMessage(), Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(mContext, mContext.getString(R.string.login_fail) + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
            }
    }
        ...
        mAuth.signInWithEmailAndPassword(email, pass).addOnCompleteListener(mContext, new OnCompleteListener <AuthResult>() {
            ...
            public void onComplete(@NonNull Task  <AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(mContext, mContext.getString(R.string.login_fail), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void handleForgotPassword(final EditText emailedit) {
        ...
        mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(mContext, mContext.getString(R.string.send_success), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(mContext, mContext.getString(R.string.send_fail), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
